...
class EleveDataLayer extends BaseDataLayer {
    ...
    selectAll(callback, callbackError) {
        super.connection.query("SELECT Nom, Prenom FROM Personne JOIN Eleve ON Personne.Id = Eleve.PersonneId ORDER BY Nom, Prenom;", 
            ...
            if(error) 
                ...
                results.forEach(function(item) {
                    let eleve = new Eleve(item.Nom, item.Prenom);
